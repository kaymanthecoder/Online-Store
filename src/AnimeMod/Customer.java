...
//------------Other MySql methods--------------------
//(1) If table has different structures
//INSERT INTO TARGET_TABLE ('col1', 'col2') SELECT 'col1', 'col2' FROM SOURCE_TABLE

//(2) To constrain (have or hold)
//INSERT INTO TARGET_TABLE ('col1', 'col2') SELECT 'col1', 'col2' FROM SOURCE_TABLE WHERE 'foo' = 1
...
//(5) Output table
//SELECT * INTO OUTFILE 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/babyitsyou.txt' from TABLE1

//(6) Input table
//LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/babyitsyou.txt' into table TABLE2
//Press tab for the gaps
//Make sure there are no duplicate primary keys

//(7) Add column
//ALTER TABLE table1
//ADD COLUMN col1 varchar(10)

//(8) Delete column
//ALTER TABLE table1
//DROP COLUMN col1

//(9) Update a specific column
//SET col2 = dataB2, col3 = dataC3
//WHERE col1 = dataA2
//INSERT method won't work unless everything in the row is going to change

//(10)INSERT INTO heythere ('Genin', 'Chunin', 'Jonin') SELECT 'price$', 'price$', 'quantity' FROM gaming
//genin for int, 'genin' for string

//(11) For null use = 'null'

//(12) For NULL use is null or = ''